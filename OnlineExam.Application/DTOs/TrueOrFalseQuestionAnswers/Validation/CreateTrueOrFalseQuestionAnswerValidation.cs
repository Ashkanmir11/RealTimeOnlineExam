...
{
    public class CreateTrueOrFalseQuestionAnswerValidation : AbstractValidator<CreateTrueOrFalseQuestionAnswerDTO>
    {
        private readonly ITrueOrFalseQuestionRepository _trueOrFalseQuestionRepository;
        private readonly IAccountRepository _accountRepository;

        public CreateTrueOrFalseQuestionAnswerValidation(ITrueOrFalseQuestionRepository trueOrFalseQuestionRepository, IAccountRepository accountRepository)
        {
